                        ...
                        <section class="col-lg-12 connectedSortable">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div>
                                        <?php
                                        $sql = "SELECT id,egitimadi,okuladi,baslangicyil,bitisyil,devamdurumu FROM egitim";
                                        $stmt = $pdo->query($sql);

                                        if ($stmt->rowCount() > 0) {
                                            // Tablo başlıklarını ve işlem sütununu yazdırma
                                            echo "<table><tr><th>Eğitim Adı</th><th>Okul</th><th>Başlangıç Yılı</th><th>Bitiş Yılı</th><th>Devam Durumu</th><th>İşlemler</th></tr>";
                                            $sayac = "1";
                                            ...
                                            foreach ($stmt as $row) {
                                                ...
                                                echo "<tr><td>" . $row["egitimadi"] . "</td><td>" . $row["okuladi"] . "</td><td>" . $row["baslangicyil"] . "</td><td>" . $row["bitisyil"] . "</td><td>" . $checkbox . "</td>";
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form id="updateForm" method="POST"
                                                    action="db/egitimdb/egitimguncelle.php">
                                                    <div class="form-group row">
                                                        <label for="egitimAdi" class="col-sm-2 col-form-label">Eğitim
                                                            Adı:</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" id="egitimAdi" name="egitimAdi"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="okulAdi" class="col-sm-2 col-form-label">Okul
                                                            Adı:</label>
                                                        <div class="col-sm-10">
                                    ...
                                    <div class="card" style="margin-top: 20px">
                                        <div class="card-header" style="background-color: #f2f2f2">
                                            <h3 class="card-title">Yeni Eğitim Ekle</h3>
                                        </div>
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <form action="db/egitimdb/egitimekle.php" method="POST">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="egitimAdi">Eğitim Adı</label>
                                                        <input type="egitimAdi" class="form-control" name="egitimAdi">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4">Okul Adı</label>
        ...
        <script>
            function confirmDelete(id) {
                ...
                if (result) {
                    ...
                    window.location.href = "db/egitimdb/egitimsil.php?id=" + id; // action kısmını düzelttik
                }
            }
            ...
            var egitimAdiInput = document.getElementById('egitimAdi');
            var okulAdiInput = document.getElementById('okulAdi');
